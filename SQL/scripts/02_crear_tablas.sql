...
--------------------------------------------------------------------------------
 ...
 Descripción   : Define la estructura de las tablas base del sistema de gestión de incidencias.
 Tipo de Objeto: Script de creación de tablas
 Versión       : 1.0.0
 ...
 Observaciones:
    - Incluye claves primarias, foráneas y restricciones únicas.
    - Se asume que la base de datos 'incidencias' ya fue creada y seleccionada.
--------------------------------------------------------------------------------
*/
...
-- ========================================
-- Tabla: ROL
-- Descripción: Define los roles de los usuarios del sistema.
-- ========================================
CREATE TABLE ROL (
...
-- ========================================
-- Tabla: ESTADO
-- Descripción: Representa el estado de los registros (Activo, Inactivo, etc).
-- ========================================
CREATE TABLE ESTADO (
...
-- ========================================
-- Tabla: PERSONA
-- Descripción: Información personal vinculada a los usuarios del sistema.
-- ========================================
...
-- ========================================
-- Tabla: AREA
-- Descripción: Define las áreas funcionales de la organización.
-- ========================================
CREATE TABLE AREA (
...
-- ========================================
-- Tabla: USUARIO
-- Descripción: Almacena las credenciales y datos del usuario del sistema.
-- ========================================
...
-- ========================================
-- Tabla: PRIORIDAD
-- Descripción: Niveles de prioridad para atención de incidencias.
-- ========================================
...
-- ========================================
-- Tabla: CATEGORIA
-- Descripción: Tipos de categorías para clasificar las incidencias.
-- ========================================
...
-- ========================================
-- Tabla: IMPACTO
-- Descripción: Grado de afectación de una incidencia.
-- ========================================
...
-- ========================================
-- Tabla: BIEN
-- Descripción: Recursos o bienes patrimoniales.
-- ========================================
CREATE TABLE BIEN (
...
-- ========================================
-- Tabla: INCIDENCIA
-- Descripción: Registro principal de incidencias reportadas.
-- ========================================
...
-- ========================================
-- Tabla: RECEPCION
-- Descripción: Registro de la recepción de incidencias para su atención.
--              Se asigna prioridad, impacto y técnico responsable.
-- ========================================
...
-- ========================================
-- Tabla: ASIGNACION
-- Descripción: Registro de asignación de un técnico a una incidencia recibida.
-- ========================================
...
-- ========================================
-- Tabla: MANTENIMIENTO
-- Descripción: Representa la ejecución del mantenimiento correctivo o preventivo
...
-- ========================================
-- Tabla: CONDICION
-- Descripción: Define el estado operativo de un bien luego del cierre de una incidencia.
-- Ejemplo: Operativo, No Operativo, En Observación.
-- ========================================
...
-- ========================================
-- Tabla: SOLUCION
-- Descripción: Define las posibles soluciones aplicadas durante el cierre.
-- ========================================
...
-- ========================================
-- Tabla: CIERRE
-- Descripción: Contiene el diagnóstico final, soluciones aplicadas y
--              estado final del bien una vez culminado el mantenimiento.
-- ========================================
CREATE TABLE CIERRE (
...
-- ========================================
-- Tabla: AUDITORIA
-- Descripción: Almacena el historial de operaciones realizadas en el sistema
